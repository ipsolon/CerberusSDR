...
# pll1_cfg3_los_valtime_sel[2:0] = 0x7
dut.write(0x15, 0x7)
...
# pll2_vdiv_cfg16_divratio_lsb[7:0] = 0xF
dut.write(0x35, 0xF)

# pll2_vdiv_cfg16_divratio_msb[7:0] = 0x0
dut.write(0x36, 0x0)

# pll2_cfg4_cp_gain[3:0] = 0x5
dut.write(0x37, 0x5)
...
# glbl_cfg8_gpo1_sel[7:2] = 0xA
dut.write(0x50, 0x2B)

# glbl_cfg8_gpo2_en[0:0] = 0x0
# glbl_cfg8_gpo2_mode[1:1] = 0x0
# glbl_cfg8_gpo2_sel[7:2] = 0x0
dut.write(0x51, 0x0)
...
# pll2_ro8_tunestatus[7:0] = 0x5
dut.write(0x8C, 0x5)

# pll2_ro8_vtune_error_lsb[7:0] = 0x6
dut.write(0x8D, 0x6)
...
# grpx_ro1_outdivfsm_busy[4:4] = 0x1
dut.write(0x91, 0x12)
...
# clkgrp1_div1_cfg12_divrat_lsb[7:0] = 0x6
dut.write(0xC9, 0x6)
...
# clkgrp1_div1_cfg2_sel_outmux[1:0] = 0x2
...
# clkgrp1_div2_cfg12_divrat_lsb[7:0] = 0x6
dut.write(0xD3, 0x6)
...
# clkgrp2_div1_cfg12_divrat_lsb[7:0] = 0x6
dut.write(0xDD, 0x6)
...
# clkgrp2_div1_cfg2_sel_outmux[1:0] = 0x2
...
# clkgrp2_div2_cfg12_divrat_lsb[7:0] = 0x6
dut.write(0xE7, 0x6)
...
# clkgrp3_div1_cfg2_startmode[3:2] = 0x3
...
# clkgrp3_div1_cfg12_divrat_lsb[7:0] = 0x40
dut.write(0xF1, 0x40)
...
# clkgrp3_div2_cfg12_divrat_lsb[7:0] = 0x5
dut.write(0xFB, 0x5)
...
# clkgrp5_div1_cfg12_divrat_msb[3:0] = 0x1
dut.write(0x11A, 0x1)
...
# clkgrp5_div2_cfg2_startmode[3:2] = 0x2
...
dut.write(0x122, 0xF8)

# clkgrp5_div2_cfg12_divrat_lsb[7:0] = 0xFE
dut.write(0x123, 0xFE)
...
# clkgrp5_div2_cfg5_drvr_res[1:0] = 0x1
...
# clkgrp6_div1_cfg2_sel_outmux[1:0] = 0x2
...
dut.write(0x140, 0x7A)

# clkgrp7_div1_cfg12_divrat_lsb[7:0] = 0x5
dut.write(0x141, 0x5)
...
# clkgrp7_div1_cfg2_sel_outmux[1:0] = 0x2
...
dut.write(0x14A, 0x7E)

# clkgrp7_div2_cfg12_divrat_lsb[7:0] = 0x5
dut.write(0x14B, 0x5)
...
# clkgrp7_div2_cfg5_drvr_res[1:0] = 0x1
